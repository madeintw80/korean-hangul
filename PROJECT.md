...
- `course-data.js`：九關 40 音課程、組合表分類、七種可單獨播放的代表收尾音、11 個雙收音規則與五類基礎音變資料。
...
- 靜態結構、三聲線 522 個 MP3 覆蓋、核心離線快取與版本一致性檢查。
- 課程資料：九關、399 個母子組合、七種有獨立發音的代表收尾音、11 個雙收音及其連音／例外、五類基礎音變與四種自動朗讀測驗模式。
