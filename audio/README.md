...
本資料夾收錄 korean-hangul v3.2.1-preview 的固定教材音檔，讓母音、子音、單／雙收尾音、音變、團名、常用句與既有歌詞不必逐次呼叫雲端 TTS。

目前共有 178 段固定教材、三套聲線，共 534 個 MP3；流音化四個例字新增 12 個音檔，連同其他音變教材均列入 PWA 核心離線快取。核心快取目前共 279 個 MP3。
