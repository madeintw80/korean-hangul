...
| 2026-07-24 | 音變篇加入「流音化」與兩種方向的四個例字 | PM 指定補上 ㄴ／ㄹ 規則；依標準發音法第 20 條，ㄴ 在 ㄹ 前後通常變成 ㄹ | PM＋Echo |
| 2026-07-24 | 流音化固定教材同步更新 Sarah／Olivia／Emily | 延續固定教材三聲線同批更新規則，避免播放時退回裝置聲線 | PM＋Echo |
| 2026-07-24 | v3.2.1-preview 維持本機版本，不自行 push／deploy | 本回合沒有新的公開發布授權 | Echo（權限邊界） |
| 2026-07-24 | 標準發音篇擴充為 12 類，涵蓋《標準發音法》第 4～7、15～16、18～20、23～30 條的初學重點 | PM 要求檢查整個 App 是否仍漏標準發音，不能只停在既有六類 | PM＋Echo |
...
| 2026-07-26 | 測驗音節與歌詞短詞改用完整韓文語境生成後裁切，逐字跟讀不再降到 0.65x | 雖然實際檔案已是 Sarah／Olivia／Emily，孤立短音與過度降速仍會讓音色漂移，聽感像裝置女聲 | PM＋Echo |
